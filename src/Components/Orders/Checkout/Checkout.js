...
class Checkout extends Component {
    ...
    submitHandler = () => {
        ...
        axios.post("https://burger-f8ee6-default-rtdb.firebaseio.com/orders.json?auth=" + this.props.token, order)
            .then(response => {
    ...
    render() {
        let form = (<div>
            ...
            <form style={{
                ...
                <br />
                <Button color="dark" className="me-auto" onClick={this.submitHandler} disabled={!this.props.purchasable}>Place Order</Button>
                <Button style={{ backgroundColor: "#FEB900", color: "#1B1A1A" }} className="ms-1" onClick={this.goBack}>Cancel</Button>
            </form>
        </div>)
        return (
            <div>
